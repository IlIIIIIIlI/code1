    ...
    <v-col align="center" class="text-center">
        ...
        <div v-else class="my-6">
            <v-card class="mx-auto" max-width="600" outlined>
                <v-card-text>
                    <p v-if="!reveal && !waiting && questionID>=20 && questionID<=27" class="my-1 body-2 font-weight-regular">As a group, discuss the following decision. You have 150s to finish your choice.</p>
                    <p v-else-if="!reveal && !waiting && questionID>100" class="my-1 body-2 font-weight-regular">Below is a personal question, you have 60s to finish your choice.</p>
